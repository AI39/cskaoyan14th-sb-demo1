...
public class OrderUtil {
    ...
    public static String orderStatusText(WxOrder order) {
    ...
    public static OrderHandleOption build(WxOrder order) {
        int status = order.getOrderStatus().intValue();
